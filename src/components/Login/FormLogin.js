            ...
            <form className="form_container" onSubmit={handleonSubmit}>
                <div className="title_container">
                    ...
                    {props.title && props.title === "Iniciar sesión" ? (
                        <span className="subtitle">Bienvenido. Ingresa tus credenciales y serás dirigido a tu cuenta.</span>
                    ) : (
                        <span className="subtitle">Bienvenido. Ingresa tu correo y crea una contraseña para el registro.</span>
                    )}
                </div>
                <div className="input_container">
                    <label className="input_label" htmlFor="email_field">Correo Electronico</label>
